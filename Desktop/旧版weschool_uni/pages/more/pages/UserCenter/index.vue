                ...
                <view class="zz">
                    ...
                    <view class="zh2">
                        <view v-for="(item, index) in array" :key="index">
                            <!-- <image src="images/n.png" style="width:45rpx;height: 45rpx;"></image> -->
                    ...
                    <view class="zh3">
                        ...
                        <view class="zz3">
                            <view class="zh3-2">关注</view>
                            <view class="zh3-3">
                                <image src="/static/pages/more/pages/UserCenter/images/l.png" style="width: 45rpx; height: 45rpx"></image>
                            </view>
                        </view>
                    </view>
                </view>
