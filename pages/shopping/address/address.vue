<template>
	<view class="container">
		<view class="address-list" v-if="addressList.length > 0">
			<view class="item" @tap="selectAddress" :data-address-id="item.id" v-for="(item, index) in addressList"
				:key="item.id">
				<view class="l">
				...
				<view class="r">
					<image @tap.stop.prevent="addressAddOrUpdate" :data-address-id="item.id" class="del"
