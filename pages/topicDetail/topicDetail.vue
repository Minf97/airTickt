	...
	<view>
		<scroll-view class="container">
			...
			<scroll-view class="comments">
				...
				<view class="has-comments" v-if="commentList.length > 0">
					...
					<view class="load" v-if="commentCount > 5">
						<navigator :url="'/pages/topicComment/topicComment?valueId=' + topic.id + '&typeId=1'">查看更多
						</navigator>
					</view>
				</view>
			...
			<scroll-view class="rec-box">
				...
				<view class="b">
					<navigator class="item" :url="'../topicDetail/topicDetail?id=' + item.id"
