...
/***/ 209:
/*!*************************************************************************************************!*\
  !*** /Users/macbook/Documents/category/外包/airttcket-front/main.js?{"page":"pages%2Fbuy%2Fbuy"} ***!
  \*************************************************************************************************/
...
/***/ 210:
/*!******************************************************************************!*\
  !*** /Users/macbook/Documents/category/外包/airttcket-front/pages/buy/buy.vue ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ 211:
/*!*************************************************************************************************************!*\
  !*** /Users/macbook/Documents/category/外包/airttcket-front/pages/buy/buy.vue?vue&type=template&id=63838ed8& ***!
  \*************************************************************************************************************/
...
/***/ 212:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/macbook/Documents/category/外包/airttcket-front/pages/buy/buy.vue?vue&type=template&id=63838ed8& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 213:
/*!*******************************************************************************************************!*\
  !*** /Users/macbook/Documents/category/外包/airttcket-front/pages/buy/buy.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 214:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/macbook/Documents/category/外包/airttcket-front/pages/buy/buy.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  methods: {
    ...
    onCardImgElectron: function onCardImgElectron(index) {var _this = this;
          ...
          _util.default.request(_api.default.uploadImg).then(function (response) {
            ...
            uni.uploadFile({
              ...
              success: function success(uploadFileRes) {
                ...
                _this.setData(_defineProperty({}, "certificationInfo[".concat(
                index, "]"), item));
    ...
    onCardImgFront: function onCardImgFront(index) {var _this2 = this;
      var item = this.certificationInfo[index];
          ...
          _util.default.request(_api.default.uploadImg).then(function (response) {
            ...
            uni.uploadFile({
              ...
              success: function success(uploadFileRes) {
                ...
                _this2.setData(_defineProperty({}, "certificationInfo[".concat(
                index, "]"), item));

                console.log(_this2.certificationInfo, item);
                // data.success(backUrl); //反出去链接
                uni.hideLoading();
              },
    ...
    onCardImgBehind: function onCardImgBehind(index) {var _this3 = this;
      var item = this.certificationInfo[index];
      uni.chooseImage({
        count: 1,
        sizeType: ["original", "compressed"], //可以指定是原图还是压缩图，默认二者都有
          ...
          _util.default.request(_api.default.uploadImg).then(function (response) {
            ...
            uni.uploadFile({
              ...
              success: function success(uploadFileRes) {
                ...
                _this3.setData(_defineProperty({}, "certificationInfo[".concat(
                index, "]"), item));
    ...
    buy: function buy() {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var guigeArr, isWeekend, i;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                uni.showLoading();
                // 校验表单
                if (_this4.isCheckedAllSpec()) {_context.next = 3;break;}return _context.abrupt("return");case 3:_context.prev = 3;_context.next = 6;return (





                  _this4.productDlete());case 6:_context.next = 8;return (

                  _this4.goodsClear());case 8:
                // 加入购物车
                guigeArr = _this4.ticketInfo.guigeArr;
                isWeekend = _this4.isWeekend(_this4.ticketInfo.choosetime);
                ...
                i = 0;case 12:if (!(i < guigeArr.length)) {_context.next = 18;break;}_context.next = 15;return (
                  _this4.addToCart(guigeArr[i], i, isWeekend));case 15:i++;_context.next = 12;break;case 18:

                // 调起支付
                _this4.submitOrder();_context.next = 24;break;case 21:_context.prev = 21;_context.t0 = _context["catch"](3);
    ...
    // 加入购物车
    addToCart: function addToCart(ticket, index, isWeekend) {var _this5 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:

                _this5.certificationInfo[index]["choosetime"] = _this5.ticketInfo.choosetime;
                console.log(_this5.certificationInfo[index]);_context2.next = 4;return (
                  ...
                  _api.default.CartAdd, {
                    ...
                    certification: JSON.stringify([_this5.certificationInfo[index]]),
                    isWeekend: isWeekend },
    ...
    // 删除购物车中的票类商品
    productDlete: function productDlete() {var _this6 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                  _util.default.request(
...
/***/ 218:
/*!***************************************************************************************************************!*\
  !*** /Users/macbook/Documents/category/外包/airttcket-front/pages/buy/buy.vue?vue&type=style&index=0&lang=css& ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 219:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/macbook/Documents/category/外包/airttcket-front/pages/buy/buy.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
